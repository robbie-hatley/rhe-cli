...
string "sjfhrrsiggghhhh" would be 3 if "hhhh" is rejected as "not being unique" seeing as how "h" has already
been used previously. But if "unique" means "within one substrig", then the "power" is 4. I'll assume the
...
./ch-1.pl '("rat", "book", "thinnngamajig","LOOOOOD!!!","Ooooooooh, myyyyyyy!!!")'
