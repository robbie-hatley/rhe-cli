...
--------------------------------------------------------------------------------------------------------------
PROBLEM NOTES:
Fortunately, I already wrote a "number to words" script long ago. It's complicated. And it's in English
only, because that's the only language I know the number words for. You'll just have to read the script.
...
# PRAGMAS, MODULES, AND SUBS:
   ...
   sub make_big_ints ( @n ) {
      ...
      foreach my $n (@n) {
         ...
         my $b = Math::BigInt->new(Math::BigFloat->new($n)->bint());
